...
def median_random_forest_time_step( timeStep, round, location, board ):
    TIME_STEP = timeStep
...
def plot_median_random_forest_time_step( timeStep, round, location, board ):
  
    if not os.path.exists("my_plots/Median/Random_Forest" ):
        os.mkdir( "my_plots/Median/Random_Forest" )
   
    if not os.path.exists("my_plots/Median/Random_Forest/predicted_o3_Vs_epa_o3" ):
        os.mkdir( "my_plots/Median/Random_Forest/predicted_o3_Vs_epa_o3" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_o3_Vs_epa_o3/round1" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_o3_Vs_epa_o3/round2" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_o3_Vs_epa_o3/round3" )

    if not os.path.exists("my_plots/Median/Random_Forest/predicted_no2_Vs_epa_no2" ):
        os.mkdir( "my_plots/Median/Random_Forest/predicted_no2_Vs_epa_no2" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_no2_Vs_epa_no2/round1" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_no2_Vs_epa_no2/round2" )
        os.mkdir( "my_plots/Median/Random_Forest/predicted_no2_Vs_epa_no2/round3" )

    test = median_random_forest_time_step( timeStep, round, location, board )
    ...
    plt.savefig("my_plots/Median/Random_Forest/" + "predicted_no2_Vs_epa_no2" + "/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + "new.png") 
    plt.clf()
    ...
    plt.savefig("my_plots/Median/Random_Forest/" + "predicted_o3_Vs_epa_o3" + "/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + "new.png") 
    plt.clf()


time = 0 
plot_median_random_forest_time_step( time, 1, 'donovan', 17 )
plot_median_random_forest_time_step( time, 1, 'donovan', 19 ) 
plot_median_random_forest_time_step( time, 1, 'donovan', 21 )
plot_median_random_forest_time_step( time, 1, 'elcajon', 11 )
plot_median_random_forest_time_step( time, 1, 'elcajon', 12 )
plot_median_random_forest_time_step( time, 1, 'elcajon', 13 )
plot_median_random_forest_time_step( time, 1, 'shafter', 15 )
plot_median_random_forest_time_step( time, 1, 'shafter', 18 )
plot_median_random_forest_time_step( time, 1, 'shafter', 20 )
plot_median_random_forest_time_step( time, 2, 'donovan', 15 )
plot_median_random_forest_time_step( time, 2, 'donovan', 18 )
plot_median_random_forest_time_step( time, 2, 'donovan', 20 )
plot_median_random_forest_time_step( time, 2, 'elcajon', 17 )
plot_median_random_forest_time_step( time, 2, 'elcajon', 19 )
plot_median_random_forest_time_step( time, 2, 'elcajon', 21 )
plot_median_random_forest_time_step( time, 2, 'shafter', 11 )
plot_median_random_forest_time_step( time, 2, 'shafter', 12 )
plot_median_random_forest_time_step( time, 2, 'shafter', 13 )
plot_median_random_forest_time_step( time, 3, 'donovan', 11 )
plot_median_random_forest_time_step( time, 3, 'donovan', 12 )
plot_median_random_forest_time_step( time, 3, 'donovan', 13 )
plot_median_random_forest_time_step( time, 3, 'elcajon', 15 )
plot_median_random_forest_time_step( time, 3, 'elcajon', 18 )
plot_median_random_forest_time_step( time, 3, 'elcajon', 20 )
plot_median_random_forest_time_step( time, 3, 'shafter', 17 )
plot_median_random_forest_time_step( time, 3, 'shafter', 19 ) 
plot_median_random_forest_time_step( time, 3, 'shafter', 21 ) 

...
def median_linear_time_step( timeStep, round, location, board ):
    TIME_STEP = timeStep
...
def plot_median_linear_time_step( timeStep, round, location, board ):
    ...
    if not os.path.exists("my_plots/Median/Linear" ):
        os.mkdir( "my_plots/Median/Linear" )
   
    if not os.path.exists("my_plots/Median/Linear/predicted_o3_Vs_epa_o3" ):
        os.mkdir( "my_plots/Median/Linear/predicted_o3_Vs_epa_o3" )
        os.mkdir( "my_plots/Median/Linear/predicted_o3_Vs_epa_o3/round1" )
        os.mkdir( "my_plots/Median/Linear/predicted_o3_Vs_epa_o3/round2" )
        os.mkdir( "my_plots/Median/Linear/predicted_o3_Vs_epa_o3/round3" )

    if not os.path.exists("my_plots/Median/Linear/predicted_no2_Vs_epa_no2" ):
        os.mkdir( "my_plots/Median/Linear/predicted_no2_Vs_epa_no2" )
        os.mkdir( "my_plots/Median/Linear/predicted_no2_Vs_epa_no2/round1" )
        os.mkdir( "my_plots/Median/Linear/predicted_no2_Vs_epa_no2/round2" )
        os.mkdir( "my_plots/Median/Linear/predicted_no2_Vs_epa_no2/round3" )

    test = median_linear_time_step( timeStep, round, location, board )
    ...
    plt.savefig("my_plots/Median/Linear/" + "predicted_no2_Vs_epa_no2" + "/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()
    ...
    plt.savefig("my_plots/Median/Linear/" + "predicted_o3_Vs_epa_o3" + "/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()


time = 0
plot_median_linear_time_step( time, 1, 'donovan', 17 ) #DONE

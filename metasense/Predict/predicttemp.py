...
def linear_time_step( timeStep, round, location, board ):
    ...
    trainY = train[TIME_STEP::, TEMP_INDEX]
    ...
    testY = test[TIME_STEP::, TEMP_INDEX]
...
def plot_linear_time_step( timeStep, round, location, board ):
    ...
    if not os.path.exists("my_plots/Mean/Linear/predicting_temp" ):
        os.mkdir( "my_plots/Mean/Linear/predicting_temp" )
        os.mkdir( "my_plots/Mean/Linear/predicting_temp/round1" )
        os.mkdir( "my_plots/Mean/Linear/predicting_temp/round2" )
        os.mkdir( "my_plots/Mean/Linear/predicting_temp/round3" )
    ...
    plt.title( "actual temp Vs. predicted temp: " + str(location) + " board " + str(board) ) 
    plt.savefig("my_plots/Mean/Linear/predicting_temp/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()

...
def linear_time_step( timeStep, round, location, board ):
    ...
    train = data[0]
    test = data[1]
    trainX = train[TIME_STEP::, O3_INDEX]
    ...
    trainY = train[TIME_STEP::, NO2_INDEX]
    trainY = np.expand_dims(trainY, axis=1)
    lr.fit(trainX, trainY) 
    
    testX = test[TIME_STEP::, O3_INDEX]
    ...
    testY = test[TIME_STEP::, NO2_INDEX]
...
def plot_linear_time_step( timeStep, round, location, board ):
    ...
    if not os.path.exists("my_plots/Mean/Linear/predicting_no2" ):
        os.mkdir( "my_plots/Mean/Linear/predicting_no2" )
        os.mkdir( "my_plots/Mean/Linear/predicting_no2/round1" )
        os.mkdir( "my_plots/Mean/Linear/predicting_no2/round2" )
        os.mkdir( "my_plots/Mean/Linear/predicting_no2/round3" )
    ...
    plt.savefig("my_plots/Mean/Linear/predicting_no2/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()

...
def linear_time_step( timeStep, round, location, board ):
    ...
    trainY = train[TIME_STEP::, HUM_INDEX]
    ...
    testY = test[TIME_STEP::, HUM_INDEX]
...
def plot_linear_time_step( timeStep, round, location, board ):
    ...
    if not os.path.exists("my_plots/Mean/Linear/predicting_hum" ):
        os.mkdir( "my_plots/Mean/Linear/predicting_hum" )
        os.mkdir( "my_plots/Mean/Linear/predicting_hum/round1" )
        os.mkdir( "my_plots/Mean/Linear/predicting_hum/round2" )
        os.mkdir( "my_plots/Mean/Linear/predicting_hum/round3" )
    ...
    plt.title( "actual humidity Vs. predicted humidity: " + str(location) + " board " + str(board) ) 
    plt.savefig("my_plots/Mean/Linear/predicting_hum/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()

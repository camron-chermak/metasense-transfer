...
def linear_time_step( timeStep, round, location, board ):
    ...
    trainY = train[TIME_STEP::, O3_INDEX]
...
def plot_linear_time_step( timeStep, round, location, board ):
    ...
    if not os.path.exists("my_plots/Mean/Linear/predicting_o3" ):
        os.mkdir( "my_plots/Mean/Linear/predicting_o3" )
        os.mkdir( "my_plots/Mean/Linear/predicting_o3/round1" )
        os.mkdir( "my_plots/Mean/Linear/predicting_o3/round2" )
        os.mkdir( "my_plots/Mean/Linear/predicting_o3/round3" )
    ...
    plt.savefig("my_plots/Mean/Linear/predicting_o3/round" + str(round) + "/" + str(round) + "-" + location + "-" + str(board) + "-" + str(timeStep) + ".png") 
    plt.clf()
